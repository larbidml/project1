        ...
        <div class="col-12 col-lg-10">
            ...
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div><i class="bi bi-person-fill-add me-2"></i><strong>Añadir Conyuge</strong></div>
                </div>
                ...
                <div class="card-body " style="background-color: gray;">
                    ...
                    <!-- FORMULARIO -->
                    <form method="post" action="add_nuevo_R.php" class="row g-3">

                        <input type="hidden" name="action" value="add_hijo">
                        <input type="hidden" name="csrf_token" value="<?php echo e($csrf); ?>">
                        <input type="hidden" name="idfamilar" value="<?php echo e($idfamilar); ?>">
                        <input type="hidden" name="tiposocio" value="<?php echo e($tiposocio); ?>"> 
                        ...
                        <div class="col-12 d-flex justify-content-end gap-2">
                            ...
                            <button class="btn btn-primary" type="submit" id="submit-btn">Guardar Conyuge</button>
                        </div>
